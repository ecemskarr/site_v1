                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <a href="../admin/Login/logout.php" class="btn btn-default btn-flat">Çıkış Yap</a>
                                </div>
                            </li>
                        </ul>
                    </li>
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li>
                     <a href="hakkimizda.php">
                        <i class="fa fa-th"></i> <span>Hakkımızda</span>
					</a>
                </li>
                <li>
                     <a href="ayarlar.php">
                ...
                <li>
                     <a href="referans.php">
                        <i class="fa fa-th"></i> <span>Referanslarımız</span>
					</a>
                </li>
                <li>
                     <a href="referansKategori.php">
                        <i class="fa fa-th"></i> <span>Referans Kategori</span>
					</a>
                </li>
                <li>
                     <a href="hizmet.php">
                        <i class="fa fa-th"></i> <span>Hizmetlerimiz</span>
					</a>
                </li>
                <li>
                     <a href="haber.php">
